<template>
  <main class="container mx-auto px-6 pt-6">
    ...
    >
      ...
      <p class="mb-2 text-sm font-semibold uppercase text-blue-700 dark:text-blue-400">
        Climate model intelligence
      </p>
      <h1 class="mb-3 text-2xl font-semibold text-gray-800 sm:text-3xl dark:text-gray-100">
        CMIP7 Dashboard
      </h1>
      <p class="text-sm leading-relaxed text-gray-500 sm:text-base dark:text-gray-400">
    ...
    >
      <h2 class="text-sm font-semibold uppercase text-gray-700 dark:text-gray-200">About</h2>
      <p>
